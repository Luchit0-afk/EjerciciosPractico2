...
public class interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Este boton no sirve para nada");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pantalla, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if(pantalla.getText().length() > 0){
            n2 = Integer.parseInt(pantalla.getText());
            switch(signo){
                case '+':
                    res = n1 + n2;
                    pantalla.setText(Integer.toString(res));
                    break;
                case '-':
                    res = n1 - n2;
                    pantalla.setText(Integer.toString(res));
