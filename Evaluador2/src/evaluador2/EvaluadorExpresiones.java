...
public class EvaluadorExpresiones {
	...
	*/
	public Map<String, Boolean> evaluar() {
		try {
			...
			for (String line : Files.readAllLines(archivoEntrada.toPath(),Charset.defaultCharset())){
	...
	*/
	private boolean esPalindromo(String palin) {
	...
	*/
	private boolean parentesisBalanceados(String formula) {
        Pila<Character> pila = new PilaEncadenada();
